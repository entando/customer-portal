...
public class TicketSchemaResource {

    private final Logger log = LoggerFactory.getLogger(TicketSchemaResource.class);

    @GetMapping(value = "/ticket", produces = "application/schema+json")
