...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/partner/tableWidget/>):
    1. Run `npm i`
...
-   **partner.table.error** (fired when an error occurs)
-   **partner.table.select** (fired when a table row is selected)
