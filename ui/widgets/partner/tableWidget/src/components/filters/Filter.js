    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="name">{t('entities.partner.name')}</option>
            <option value="partnerNumber">{t('entities.partner.partnerNumber')}</option>
            <option value="notes">{t('entities.partner.notes')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
