...
class PartnerDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'partner.details.';
    ...
    const ReactComponent = React.createElement(PartnerDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('partner-details', PartnerDetailsElement);
