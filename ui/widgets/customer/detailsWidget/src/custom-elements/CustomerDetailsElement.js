...
class CustomerDetailsElement extends HTMLElement {
  ...
  render() {
    const customEventPrefix = 'customer.details.';
    ...
    const ReactComponent = React.createElement(CustomerDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('customer-details', CustomerDetailsElement);
