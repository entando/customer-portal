...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/customer/tableWidget/>):
    1. Run `npm i`
...
-   **customer.table.error** (fired when an error occurs)
-   **customer.table.select** (fired when a table row is selected)
