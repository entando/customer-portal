    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="name">{t('entities.customer.name')}</option>
            <option value="customerNumber">{t('entities.customer.customerNumber')}</option>
            <option value="contactName">{t('entities.customer.contactName')}</option>
            <option value="contactPhone">{t('entities.customer.contactPhone')}</option>
            <option value="contactEmail">{t('entities.customer.contactEmail')}</option>
            <option value="notes">{t('entities.customer.notes')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
