...
class TicketDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'ticket.details.';
    ...
    const ReactComponent = React.createElement(TicketDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('ticket-details', TicketDetailsElement);
