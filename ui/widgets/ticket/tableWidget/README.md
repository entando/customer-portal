...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/ticket/tableWidget/>):
    1. Run `npm i`
...
-   **ticket.table.error** (fired when an error occurs)
-   **ticket.table.select** (fired when a table row is selected)
