...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/projectSubscription/formWidget/>):
    1. Run `npm i`
...
-   **projectSubscription.form.createError** (fired when an error occurs during projectSubscription creation)
-   **projectSubscription.form.create** (fired when the projectSubscription is successfully created)
-   **projectSubscription.form.updateError** (fired when an error occurs during projectSubscription update)
-   **projectSubscription.form.update** (fired when the projectSubscription is successfully updated)
