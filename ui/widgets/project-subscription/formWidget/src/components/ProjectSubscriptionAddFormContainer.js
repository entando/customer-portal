...
class ProjectSubscriptionAddFormContainer extends PureComponent {
  constructor(props) {
    super(props);
  ...
  async handleSubmit(projectSubscription) {
    ...
    if (authenticated) {
      try {
        const createdProjectSubscription = await apiProjectSubscriptionPost(
          serviceUrl,
          projectSubscription
        );
        onCreate(createdProjectSubscription);
        this.setState({
    ...
    return (
      <>
        ...
        <AuthenticatedView keycloak={keycloak}>
          <ProjectSubscriptionForm onSubmit={this.handleSubmit} onCancelEditing={onCancelEditing} />
        </AuthenticatedView>
        <Notification
...
ProjectSubscriptionAddFormContainer.propTypes = {
...
ProjectSubscriptionAddFormContainer.defaultProps = {
  onError: () => {},
  onCancelEditing: () => {},
  onCreate: () => {},
  serviceUrl: '',
...
export default withKeycloak(withTranslation()(ProjectSubscriptionAddFormContainer));
