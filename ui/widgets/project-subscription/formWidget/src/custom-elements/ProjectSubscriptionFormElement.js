...
class ProjectSubscriptionFormElement extends HTMLElement {
  jss;
...
customElements.define('project-subscription-form', ProjectSubscriptionFormElement);
