...
class ProjectSubscriptionDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'projectSubscription.details.';
    ...
    const ReactComponent = React.createElement(ProjectSubscriptionDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('project-subscription-details', ProjectSubscriptionDetailsElement);
