...
class ProjectSubscriptionTableElement extends HTMLElement {
  muiTheme;
        ...
        <StylesProvider jss={this.jss}>
          <ThemeProvider theme={this.muiTheme}>
            <PaginationProvider paginationMode={paginationMode}>
              <ProjectSubscriptionTableContainer
...
customElements.define('project-subscription-table', ProjectSubscriptionTableElement);
