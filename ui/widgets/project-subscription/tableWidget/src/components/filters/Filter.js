    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="level">{t('entities.projectSubscription.level')}</option>
            <option value="status">{t('entities.projectSubscription.status')}</option>
            <option value="lengthInMonths">
              {t('entities.projectSubscription.lengthInMonths')}
            </option>
            <option value="startDate">{t('entities.projectSubscription.startDate')}</option>
            <option value="notes">{t('entities.projectSubscription.notes')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
