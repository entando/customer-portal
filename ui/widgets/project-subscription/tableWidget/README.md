...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/projectSubscription/tableWidget/>):
    1. Run `npm i`
...
-   **projectSubscription.table.error** (fired when an error occurs)
-   **projectSubscription.table.select** (fired when a table row is selected)
