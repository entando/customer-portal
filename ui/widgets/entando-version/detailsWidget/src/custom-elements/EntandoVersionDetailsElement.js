...
class EntandoVersionDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'entandoVersion.details.';
    ...
    const ReactComponent = React.createElement(EntandoVersionDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('entando-version-details', EntandoVersionDetailsElement);
