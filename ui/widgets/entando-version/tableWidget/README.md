...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/entandoVersion/tableWidget/>):
    1. Run `npm i`
...
-   **entandoVersion.table.error** (fired when an error occurs)
-   **entandoVersion.table.select** (fired when a table row is selected)
