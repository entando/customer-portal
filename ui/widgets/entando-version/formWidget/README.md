...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/entandoVersion/formWidget/>):
    1. Run `npm i`
...
-   **entandoVersion.form.createError** (fired when an error occurs during entandoVersion creation)
-   **entandoVersion.form.create** (fired when the entandoVersion is successfully created)
-   **entandoVersion.form.updateError** (fired when an error occurs during entandoVersion update)
-   **entandoVersion.form.update** (fired when the entandoVersion is successfully updated)
