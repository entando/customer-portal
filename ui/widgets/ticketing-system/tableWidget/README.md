...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/ticketingSystem/tableWidget/>):
    1. Run `npm i`
...
-   **ticketingSystem.table.error** (fired when an error occurs)
-   **ticketingSystem.table.select** (fired when a table row is selected)
