    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="url">{t('entities.ticketingSystem.url')}</option>
            <option value="serviceAccount">{t('entities.ticketingSystem.serviceAccount')}</option>
            <option value="serviceAccountSecret">
              {t('entities.ticketingSystem.serviceAccountSecret')}
            </option>
            <option value="systemId">{t('entities.ticketingSystem.systemId')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
