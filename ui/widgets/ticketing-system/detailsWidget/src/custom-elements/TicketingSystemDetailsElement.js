...
class TicketingSystemDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'ticketingSystem.details.';
    ...
    const ReactComponent = React.createElement(TicketingSystemDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('ticketing-system-details', TicketingSystemDetailsElement);
