...
class TicketingSystemFormElement extends HTMLElement {
  jss;
  ...
  render() {
    ...
    const FormContainer = id
      ? React.createElement(
          TicketingSystemEditFormContainer,
          { id, onUpdate: this.onUpdate, onError: this.onErrorUpdate, serviceUrl },
          null
        )
      : React.createElement(
          TicketingSystemAddFormContainer,
          { onCreate: this.onCreate, onError: this.onErrorCreate, serviceUrl },
          null
        );
...
customElements.define('ticketing-system-form', TicketingSystemFormElement);
