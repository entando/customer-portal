...
class PortalUserDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'portalUser.details.';
    ...
    const ReactComponent = React.createElement(PortalUserDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('portal-user-details', PortalUserDetailsElement);
