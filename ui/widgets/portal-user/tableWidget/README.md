...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/portalUser/tableWidget/>):
    1. Run `npm i`
...
-   **portalUser.table.error** (fired when an error occurs)
-   **portalUser.table.select** (fired when a table row is selected)
