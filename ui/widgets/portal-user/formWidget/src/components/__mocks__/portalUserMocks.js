const portalUserMock = {
  ...
  email:
    'Id odio et aut. Sit explicabo iste voluptate ea quia. Ut minima aut ipsam laudantium fugit ipsam qui. Sit sit saepe accusantium rerum maiores.',
};

export default portalUserMock;
