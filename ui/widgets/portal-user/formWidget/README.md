...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/portalUser/formWidget/>):
    1. Run `npm i`
...
-   **portalUser.form.createError** (fired when an error occurs during portalUser creation)
-   **portalUser.form.create** (fired when the portalUser is successfully created)
-   **portalUser.form.updateError** (fired when an error occurs during portalUser update)
-   **portalUser.form.update** (fired when the portalUser is successfully updated)
