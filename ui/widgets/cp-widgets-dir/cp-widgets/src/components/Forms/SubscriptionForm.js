...
export default class SubscriptionForm extends Component {
            ...
            <div className="bx--grid">
              <div className="bx--row">
                <div className="bx--col">
                  ...
                  >
                    <SelectItem text={i18n.t('subscriptionForm.selectType')} value="customer-type" />
                    {customerType.map((customerType, i) => (
                      <SelectItem key={i} text={customerType} required value={customerType.toLowerCase()}>
                        {customerType}
                      </SelectItem>
                    ))}
                  </Select>
  ...
  renderForm() {
        ...
        <div>
          ...
          <div className="bx--row">
            <div className="bx--col">
              ...
              />
              <Select
                defaultValue="subscription-level"
                name="subscriptionLevel"
                labelText={i18n.t('subscriptionForm.desiredSubscriptionLevel')}
                value={this.state.subscriptionLevel}
                onChange={this.handleChanges}
              >
                <SelectItem text={i18n.t('subscriptionForm.chooseOption')} value="subscription-level" />
                {subscriptionLevel.map((subscriptionLevel, i) => (
                  <SelectItem key={i} text={subscriptionLevel} value={subscriptionLevel.toLowerCase()}>
                    {subscriptionLevel}
                  </SelectItem>
                ))}
              </Select>
              ...
              <TextInput
                name="contactNumber"
                labelText={i18n.t('subscriptionForm.contactNumber')}
            ...
            <div className="bx--col">
              ...
              <Select
                defaultValue="subscription-length"
                name="subscriptionLength"
                labelText={i18n.t('subscriptionForm.desiredSubscriptionLength')}
                value={this.state.subscriptionLength}
                onChange={this.handleChanges}
              >
                <SelectItem text={i18n.t('subscriptionForm.chooseOption')} value="subscription-length" />
                {subscriptionLength.map((subscriptionLength, i) => (
                  <SelectItem key={i} text={subscriptionLength} value={subscriptionLength.toLowerCase()}>
                    {subscriptionLength}
                  </SelectItem>
                ))}
              </Select>
    ...
    if (this.state.customerType === 'existing')
      return (
        <div>
          <p>
