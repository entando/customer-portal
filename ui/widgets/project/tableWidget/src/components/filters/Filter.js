    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="name">{t('entities.project.name')}</option>
            <option value="description">{t('entities.project.description')}</option>
            <option value="systemId">{t('entities.project.systemId')}</option>
            <option value="contactName">{t('entities.project.contactName')}</option>
            <option value="contactPhone">{t('entities.project.contactPhone')}</option>
            <option value="contactEmail">{t('entities.project.contactEmail')}</option>
            <option value="notes">{t('entities.project.notes')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
