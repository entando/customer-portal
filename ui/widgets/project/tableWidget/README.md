...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/project/tableWidget/>):
    1. Run `npm i`
...
-   **project.table.error** (fired when an error occurs)
-   **project.table.select** (fired when a table row is selected)
