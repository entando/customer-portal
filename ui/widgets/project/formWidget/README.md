...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/project/formWidget/>):
    1. Run `npm i`
...
-   **project.form.createError** (fired when an error occurs during project creation)
-   **project.form.create** (fired when the project is successfully created)
-   **project.form.updateError** (fired when an error occurs during project update)
-   **project.form.update** (fired when the project is successfully updated)
