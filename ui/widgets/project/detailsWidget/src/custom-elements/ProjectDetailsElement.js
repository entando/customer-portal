...
class ProjectDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'project.details.';
    ...
    const ReactComponent = React.createElement(ProjectDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
